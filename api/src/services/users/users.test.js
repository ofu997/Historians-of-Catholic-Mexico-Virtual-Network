...
describe('users', () => {
  ...
  scenario('creates a user', async () => {
    const result = await createUser({
      input: { email: 'String3639418', name: 'String', password: 'String' },
    })

    expect(result.email).toEqual('String3639418')
  ...
  scenario('updates a user', async (scenario) => {
    ...
    const result = await updateUser({
      id: original.id,
      input: { email: 'String59265012' },
    })

    expect(result.email).toEqual('String59265012')
  })
