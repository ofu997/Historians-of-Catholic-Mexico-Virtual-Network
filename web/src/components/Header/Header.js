...
const Header = props => {
  ...
  const spanishBool = Boolean(props.language === 'Spanish');
  return(
    <>
      ...
      >
        ...
        <Navbar.Brand href="/">{ spanishBool? spanishHeader : englishHeader }</Navbar.Brand>
        <Navbar.Toggle
          ...
          >
            <Nav.Item>
              <Nav.Link
                href={routes.about()}
              >
                <p className='nav-item'>{ spanishBool? `SOBRE NOSOTROS`:`ABOUT` }</p>
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link
              ...
              >
                <p className='nav-item'>{ spanishBool? `PERFILES`:`PROFILES` }</p>
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
              <Nav.Link>
                <p className='nav-item'>{ spanishBool? `ANUNCIOS`:`ANNOUNCEMENTS` }</p>
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
